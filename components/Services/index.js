...
const Services = () => {
  ...
  return (
    <div className='bg-black pb-[25px]' style={{marginTop: -(menuHeight+252)}}>
      <div className='relative z-10 px-[23px] grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5' style={{paddingTop: menuHeight+255}}>
      {services.map((service) => (
        ...
        after:h-full after:top-0 after:left-0 after:bg-[rgba(0,0,0,0.7)] ">
          ...
          <div className={`text-center text-[44px] mt-[120px] lg:mt-[150px] relative z-[5] text-white`}>
            {service.name}
          </div>
