...
const Contact = () => {
  ...
  return (
    <div className={`relative min-h-[800px] ${css.background}`} style={{marginTop: -(menuHeight+252)}}>
        <Image
            src="/contactBg.png"
            alt="contact"
            layout='fill'
        ...
        <form className='pb-[80px] relative z-10 text-white' onSubmit={handleSubmit} style={{paddingTop: menuHeight + 307}}>
          <div className='p-[40px] md:p-[85px] mx-auto max-w-full w-[845px] bg-[rgba(0,0,0,0.47)] rounded-none
            ...
            <div className={`text-white font-[700] text-[35px] sm:text-[44px] text-center`}>
            ...
            border rounded border-[#D7B0A8] flex justify-center py-[15px] mt-[70px] w-[175px]`} type='submit'>
