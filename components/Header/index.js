  ...
  return (
    <Link href={linkHref} passHref>
      <a
        ...
        } ml-2 mb-4 font-medium uppercase text-white no-underline hover:cursor-pointer hover:text-tulip md:mb-0 md:ml-12 relative z-20`}
      >
        {linkText}
      </a>
    </Link>
...
export default function Header() {
  ...
  const {setMenuHeight} = useContext(HeaderContext)
  ...
  useEffect(() => {
    const handleResize = () => {
      if(window.innerHeight > 780) setOpen(false)
    }
    ...
    <nav className={`bg-transparent relative z-20`}>
      <div className={`container py-4 xl:px-0`}>
        ...
        >
          ...
          <div className="items-center justify-center hidden md:ml-6 md:flex relative z-10">
