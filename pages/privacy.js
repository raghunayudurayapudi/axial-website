  ...
  return (
    <>
      <SEO
        ...
        title="Privacy"
        description="Axial IT privacy policy | eCommerce fulfillment"
      />
      ...
      <div className="container py-40">
        <div>
          ...
          <p>
            Axial IT respects each individual’s right to personal privacy. We
            ...
            information collected at Axial IT("www.axialitsolutions.com”) Web site.
          </p>
          <h5>Part I. Information Collection</h5>
          <p>
            Axial IT collects information once our clients approach us. We
            collect the following information about: name, e-mail address,
            phone, and any additional comments. Axial IT does not actively
          ...
          <p>
            The information collected by Axial IT will be used for fulfillment
            ...
            differ from ours. Axial IT reserves the right to revise, amend, or
          ...
          <p>
            If problems arise, users may contact Axial IT by contacting our
            team at contactus@axial.com
          </p>
        </div>
      </div>
    </>
